              ...
              {isInnerPanelOpen && (
                ...
                >
                  ...
                  <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-6 mb-4 border border-blue-100/50">
                    ...
                    <div className="flex items-center gap-2 bg-white/90 border border-blue-100 rounded-xl p-1.5 focus-within:ring-2 focus-within:ring-blue-200 transition-all">
                      <Select
                      ...
                      <Input
                        ...
                        className="border-none focus:shadow-none hover:border-transparent"
                        suffix={
                          <Search 
                  ...
                  <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-6 mb-4 border border-blue-100/50">
                    ...
                    <div className="space-y-6">
                      ...
                      <Button
                        ...
                        className="w-full h-14 mt-6 text-lg font-bold bg-gradient-to-r from-blue-600 to-indigo-600 border-none rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                      >
                        검색하기
                      </Button>
                    </div>
