        ...
        <div className="absolute z-50 right-0 mt-2">
          <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-5 w-72">
            ...
            <div className="space-y-3">
              <div className="text-base font-semibold text-gray-700 mb-3">등급 기준</div>
              {gradeInfos.map((info) => (
                <div key={info.grade} 
                     className="flex items-center justify-between py-1.5">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded flex items-center justify-center text-gray-600 text-sm font-bold"
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 rounded-xl backdrop-blur-xl"
          ...
          <div className="absolute inset-0 rounded-xl overflow-hidden">
            ...
            {/* 상단 하이라이트 */}
            <div className="absolute -top-1/2 left-1/2 w-full h-full -translate-x-1/2 transform rotate-[-20deg]"
                 style={{
          ...
          <div className="absolute -top-2.5 left-1/2 -translate-x-1/2">
            <div className="px-4 py-1 rounded-full backdrop-blur-xl bg-white/90"
                 style={{ 
                   border: `1px solid ${info.colors.border}`,
                   boxShadow: `
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <div className="w-full py-1 flex justify-center backdrop-blur-xl"
                 style={{ 
